...
public enum ModArmorMaterials implements ArmorMaterial {
    SUTTON_HOO("sutton_hoo", 40, new int[]{4, 7, 9, 4}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.2F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    CRUSADER("crusader", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, 0.05F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    HOSPITALER("hospitaler", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, 0.05F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    TEUTONIC("teutonic", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, 0.05F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    TEMPLAR("templar", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, 0.05F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    STEEL("steel", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_IRON, 2.0F, 0.05F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    GAMBESSON("gambesson", 15, new int[]{1, 3, 5, 2}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 0.0F, 0.0F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    }),
    BRIGANDINE("brigandine", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_NETHERITE, 2.0F, 0.05F, () -> {
        return Ingredient.of(ItemInit.STEEL_INGOT.get());
    });
